  ...
  return (
    ...
    >
      ...
      <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
        <h1
          data-aos="fade-right"
          className="text-[52px] font-semibold mb-8 leading-normal text-red-500"
        >
          About Me
        </h1>
        ...
        <div className="flex mt-8 gap-2">
          <div className="flex items-center justify-center">
            <button
              data-aos="fade-up"
              className="neno-button  text-white border-2 hover:bg-red-600 border-red-700 rounded-lg py-4 px-8 relative overflow-hidden"
            >
              Resume
            </button>
          </div>
